...
import com.lti.service.InsuranceClaimService;
import com.lti.service.InsuranceService;
import com.lti.service.SellCropService;
...
public class AdminController {
	...
	@Autowired
	private InsuranceClaimService claimInsuranceService;
	@Autowired
	...
	{
		return cropService.marketPlace();
	}
...
//		System.out.println();
//		System.out.println("STATUS IS" + bidApproveDto.isStatus());
//		System.out.println();
	...
	public Status insuranceApprove(@RequestBody InsuranceApproveDto insuranceApproveDto)
	{
		...
		i.setFarmer(f);
		insuranceService.applyInsurance(i);
	...
	public Status claimApproval(@RequestBody ClaimApprovalDto dto)
	{
		...
		claim.setClaimId(dto.getClaimId());
		claimInsuranceService.claimInsurance(claim);
